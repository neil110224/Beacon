...
//   // Sync handler — only pings sync_charging (POST, no body)
//   // After sync, refetch pings charging?status=active&pagination=none
//   const [syncCharging] = useGetSyncChargingQuery({});

//   const handleSync = async () => {
//     try {
//       await syncCharging().unwrap();
//       setSnackbar({
//         open: true,
...
const Charging = () => {
  ...
  // useSyncChargingMutation returns [triggerFn, { isLoading }]
  // const [syncCharging, { isLoading: isSyncing }] = useSyncChargingQuery();
  // const { data, isLoading: isSyncing } = useSyncChargingQuery();

  // ✅ Use lazy query — only fires when you call it manually

const [syncCharging] = useLazySyncChargingQuery();
